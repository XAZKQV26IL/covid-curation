...
This Links prototype provides an interface to curate the weekly data available from 
...
It allows for the uploading of individual CSV files, adds new data to the database, and indicates when there are new values for existing data. It uses the temporal features of Links to provide valid-time information about fatality counts. The database structure is documented in the file `uploadData.links`.
...
The interface is built using the Links MVU library which utilises
